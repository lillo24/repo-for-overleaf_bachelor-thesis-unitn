...
\section{University-Oriented RAG Systems}
Recent work has explored RAG systems for academic guidance and university information. Uni-Mate presents a RAG system for prospective students, using university course and library information and evaluating generated answers through both automatic and human assessment \cite{mazzei2025unimate}. Unipa-GPT studies university-oriented QA in Italian, including corpus construction, RAG architectures, prompt design, model comparison, and answer evaluation \cite{siragusa2024unipagpt,siragusa2025phd}.

Compared with these works, this thesis is narrower. It does not try to evaluate a complete chatbot as the main contribution. Instead, it studies whether a cheap LLM can improve the input to a deterministic BM25 retriever through query rewriting.
